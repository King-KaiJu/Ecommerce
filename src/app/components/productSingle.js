  ...
  return (
    <section className="flex justify-center items-center">
        <div className="grid grid-cols-12 py-10 my-10 ml-20">
            <article className="col-span-5 ml-10 flex justify-center items-center p-10 bg-cyan-950 rounded-lg">
                <Image
                    src={`/imgs/${image}`}
                    width={500}
                    height={500}
            ...
            <article className="col-span-5 ml-20 flex flex-col items-start p-5 pl-10 bg-cyan-950 rounded-lg">
